...
## How to Use
After successfully launching the script or the command lines provided above you can enter Linux commands or using one of the special commands.

*Special Commands:
-alias: creates a shortcut for a command in the format alias <name>='<command>' and will save it in a linked-list structure.
        In order to see the aliases list enter the word alias.
        (i.e. alias ll='ls -l' will assign ll as a shortcut for the command ls -l.
